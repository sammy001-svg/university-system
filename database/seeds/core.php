...
return static function (PDO $pdo): void {
    ...
    /* ---------------- Settings ---------------- */
    $settings = [
        ['institution_name', 'Metropolitan University', 'general', 'string', 'Institution name'],
        ['institution_short_name', 'MU', 'general', 'string', 'Short name / abbreviation'],
        ['institution_motto', 'Knowledge, Integrity, Service', 'general', 'string', 'Motto'],
        ['institution_email', 'info@university.ac.ke', 'general', 'string', 'Official email'],
        ['institution_phone', '+254 20 000 0000', 'general', 'string', 'Telephone'],
        ['institution_address', 'P.O. Box 1000-00100, Nairobi', 'general', 'text', 'Postal address'],
        ['institution_website', 'https://www.university.ac.ke', 'general', 'string', 'Website'],
        ['support_email', 'ict@university.ac.ke', 'general', 'string', 'ICT helpdesk email'],
        ...
        ['currency_code', 'KES', 'finance', 'string', 'Currency code'],
        ...
        ['library_fine_per_day', '20', 'library', 'decimal', 'Overdue fine per day'],
